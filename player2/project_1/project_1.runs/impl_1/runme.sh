...
HD_PWD='C:/logic_design/final_project/player2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log player2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source player2.tcl -notrace
