...
HD_PWD='C:/logic_design/final_project/player2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player2.tcl
